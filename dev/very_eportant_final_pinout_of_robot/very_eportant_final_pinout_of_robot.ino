...
//enable pin for the axis 4, 5 and 6
#define EN_PIN4 62
#define EN_PIN5 56
#define EN_PIN6 38
#define EN_PIN123 35
...
void setup()
{
  ...
  pinMode(EN_PIN5, OUTPUT);
  pinMode(EN_PIN6, OUTPUT);  
  pinMode(EN_PIN123, OUTPUT);
  ...
  digitalWrite(EN_PIN4, HIGH); // last three joints disabled!
  digitalWrite(EN_PIN5, HIGH);
  digitalWrite(EN_PIN6, HIGH);
  digitalWrite(EN_PIN123, HIGH);
  //Serial.begin(9600);
}

void loop()
{
  // enable last three joints (4,5,6)
  delay(10000);
  digitalWrite(EN_PIN4, LOW);
   digitalWrite(EN_PIN5, LOW);
    digitalWrite(EN_PIN6, LOW);
  delay(1000);
  ...
  curPos5=90.0;
  curPos6=0.0;
  float Xhome[6]={164.5, 0.0, 241.0, 90.0, 180.0, -90.0}; // {192.5, 7.0, 269.0, 0.0, 90.01, 180.0};
  ...
  // disable last three joints (4,5,6)
